# ================================
# clients/deepseek_client_class.py
# ================================
...
class ChatDeepSeek(BaseChatOpenAI):
        ...
        **kwargs: Any,
        ...
        for i, message in enumerate(payload["messages"]):
            if message["role"] == "assistant":
                ...
                message["content"] = orjson.dumps(message["content"]).decode()
        return payload
    ...
    def _create_chat_result(
        ...
        if choices and len(choices) > 0 and hasattr(choices[0].message, "reasoning_content"):
            rtn.generations[0].message.additional_kwargs["reasoning_content"] = choices[0].message.reasoning_content
        elif choices and len(choices) > 0 and hasattr(choices[0].message, "model_extra"):
